...
export const Branding = async (interaction) => {
    ...
    const startEmbed = new EmbedBuilder()
        ...
        .setDescription(`**${interaction.user.username}**, the branding for the bot's embeds on this server has been turned ${await getBranding(interaction.guildId) ? '**Off**' : '**On**'}.`)
