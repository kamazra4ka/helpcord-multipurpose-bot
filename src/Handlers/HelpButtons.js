    ...
    switch (category) {
        case 'moderation':
            embed = new EmbedBuilder()
                ...
                .setDescription('Hey! Helpcord is a multipurpose22222 bot that can help you with a variety of tasks. Moderation, fun, economy and much more! Please choose a category to get continue.')
